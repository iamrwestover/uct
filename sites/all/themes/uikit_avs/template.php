 ...
 */
function uikit_avs_preprocess_html(&$variables) {
}

/**
 * Implements template_process_html().
 */
function uikit_avs_process_html(&$variables) {
}
 ...
 */
function uikit_avs_process_page(&$variables) {
}

/**
 * Implements template_preprocess_node().
 */
function uikit_avs_preprocess_node(&$variables) {
}

/**
 * Implements hook_process_HOOK() for node.tpl.php.
 */
function uikit_avs_process_node(&$variables) {
}

/**
 * Implements template_preprocess_region().
 */
function uikit_avs_preprocess_region(&$variables) {
}

/**
 * Implements hook_process_HOOK() for region.tpl.php.
 */
function uikit_avs_process_region(&$variables) {
}

/**
 * Implements template_preprocess_block().
 */
function uikit_avs_preprocess_block(&$variables) {
}

/**
 * Implements hook_process_HOOK() for block.tpl.php.
 */
function uikit_avs_process_block(&$variables) {
}
 ...
 * @return string
 */
function uikit_avs_textfield($variables) {
