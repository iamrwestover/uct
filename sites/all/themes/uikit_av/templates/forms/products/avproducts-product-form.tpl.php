...
<div class="uk-grid uk-grid-large">
  <div class="uk-width-1-2">
    <div class="uk-grid uk-grid-small">
      ...
      <?php if ($initial_qty_date_html): ?>
        <div class="uk-width-2-3 uk-margin-bottom"><?php print $initial_qty_date_html; ?></div>
      <?php endif; ?>
  ...
  <div class="uk-width-1-2">
    <div class="uk-grid uk-grid-small">
      ...
      <div class="uk-width-1-1 uk-margin-small-bottom"><?php print drupal_render($form['uom']['uom_group']); ?></div>
    </div>
  </div>
