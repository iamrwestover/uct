...
<!--      <div class="uk-width-1-10 <?php print $vertical_margin_class; ?>">--><?php //print drupal_render($form['info']['title']); ?><!--</div>-->
  ...
  <div class="uk-width-1-2">
    <div class="uk-grid uk-grid-small">
      ...
      <div class="uk-width-1-2 <?php print $vertical_margin_class; ?>"><?php print drupal_render($form['info']['credit_limit']); ?></div>
      <div class="uk-width-1-2 <?php print $vertical_margin_class; ?>"></div>
